    ...
    while True:
        ...
        for i, (x, y) in enumerate(train_dataloader):
            ...
            if train_step_count % valid_freq == 0:
                net.eval()
                print(f"\nStep {init_step + train_step_count} finished")
...
def acs_predict():
    ...
    dataset_dir = "../../datasets/acs-20210530-gold-3-1024-1"
    seq_len = 256
    ...
    net.load_state_dict(torch.load("../../weights/chemprot-cls-end-to-end/3-1024-1"))
    net = net.cuda()
    net.eval()

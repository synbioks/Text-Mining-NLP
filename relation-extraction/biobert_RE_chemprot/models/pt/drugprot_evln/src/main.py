...
def parse_arguments():
    ...
    parser.add_argument('--split', required = False, default="NotSpecified",
                        help = 'path to list of valid pubmed IDs. One PMID per line')
...
def main(args):
    ...
    print("NCOMB NREL {} {}".format(NCOMB, NREL))
    ...
    return compute_metrics.main(y_true, y_pred, reltype2tag, gs_rel_list, pred_rel_list, args.split)
